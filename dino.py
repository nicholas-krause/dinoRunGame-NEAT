...
DINO_IMAGES = [pygame.image.load(os.path.join("assets/Sprites", "Dino_Idle.png")), pygame.image.load(os.path.join("assets/Sprites", "Dino_Run01.png")),pygame.image.load(os.path.join("assets/Sprites", "Dino_Run02.png"))]
